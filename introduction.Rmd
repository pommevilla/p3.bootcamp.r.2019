...
* [Exploratory data analysis](https://pommevilla.github.io/p3.bootcamp.r.2019/lesson_3.html)
...
```{r}
reqs <- c("tidyverse", "reshape2", "rmarkdown")
...
Good for stats
Most commonly used by students in the biologies
